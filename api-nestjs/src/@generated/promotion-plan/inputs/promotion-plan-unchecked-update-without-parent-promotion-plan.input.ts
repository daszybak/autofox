...
import { AdPromotionUncheckedUpdateManyWithoutPromotion_planNestedInput } from '../../ad-promotion/inputs/ad-promotion-unchecked-update-many-without-promotion-plan-nested.input';
...
@InputType()
export class PromotionPlanUncheckedUpdateWithoutParentPromotionPlanInput {
    ...
    @Field(() => AdPromotionUncheckedUpdateManyWithoutPromotion_planNestedInput, {nullable:true})
    AdPromotion?: AdPromotionUncheckedUpdateManyWithoutPromotion_planNestedInput;
