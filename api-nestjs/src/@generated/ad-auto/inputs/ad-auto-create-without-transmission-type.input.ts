...
import { CategoryCreateNestedOneWithoutAdAutoConditionTypeInput } from '../../category/inputs/category-create-nested-one-without-ad-auto-condition-type.input';
...
@InputType()
export class AdAutoCreateWithoutTransmission_typeInput {
    ...
    @Field(() => CategoryCreateNestedOneWithoutAdAutoConditionTypeInput, {nullable:true})
    condition_type?: CategoryCreateNestedOneWithoutAdAutoConditionTypeInput;
