...
import { CategoryUpdateOneWithoutAdAutoVehicleTypeNestedInput } from '../../category/inputs/category-update-one-without-ad-auto-vehicle-type-nested.input';
...
@InputType()
export class AdAutoUpdateWithoutTransmission_typeInput {
    ...
    @Field(() => CategoryUpdateOneWithoutAdAutoVehicleTypeNestedInput, {nullable:true})
    vehicle_type?: CategoryUpdateOneWithoutAdAutoVehicleTypeNestedInput;
