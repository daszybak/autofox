...
import { AdAutoUpdateManyWithoutColor_interiorNestedInput } from '../../ad-auto/inputs/ad-auto-update-many-without-color-interior-nested.input';
...
@InputType()
export class CategoryUpdateWithoutAdAutoTransmissionTypeInput {
    ...
    @Field(() => AdAutoUpdateManyWithoutColor_interiorNestedInput, {nullable:true})
    AdAutoColorInterior?: AdAutoUpdateManyWithoutColor_interiorNestedInput;
