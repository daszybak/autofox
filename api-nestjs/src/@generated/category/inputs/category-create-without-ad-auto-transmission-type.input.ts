...
import { AdAutoCreateNestedManyWithoutCondition_typeInput } from '../../ad-auto/inputs/ad-auto-create-nested-many-without-condition-type.input';
...
@InputType()
export class CategoryCreateWithoutAdAutoTransmissionTypeInput {
    ...
    @Field(() => AdAutoCreateNestedManyWithoutCondition_typeInput, {nullable:true})
    AdAutoConditionType?: AdAutoCreateNestedManyWithoutCondition_typeInput;
