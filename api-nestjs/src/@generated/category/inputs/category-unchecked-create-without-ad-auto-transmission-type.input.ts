...
import { AdAutoUncheckedCreateNestedManyWithoutColor_exteriorInput } from '../../ad-auto/inputs/ad-auto-unchecked-create-nested-many-without-color-exterior.input';
...
@InputType()
export class CategoryUncheckedCreateWithoutAdAutoTransmissionTypeInput {
    ...
    @Field(() => AdAutoUncheckedCreateNestedManyWithoutColor_exteriorInput, {nullable:true})
    AdAutoColorExterior?: AdAutoUncheckedCreateNestedManyWithoutColor_exteriorInput;
