...
import { AdAutoUncheckedUpdateManyWithoutModelNestedInput } from '../../ad-auto/inputs/ad-auto-unchecked-update-many-without-model-nested.input';
...
@InputType()
export class CategoryUncheckedUpdateWithoutAdAutoTransmissionTypeInput {
    ...
    @Field(() => AdAutoUncheckedUpdateManyWithoutModelNestedInput, {nullable:true})
    AdAutoModel?: AdAutoUncheckedUpdateManyWithoutModelNestedInput;
