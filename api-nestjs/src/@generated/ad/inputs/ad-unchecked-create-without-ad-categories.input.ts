...
import { AdHouseUncheckedCreateNestedOneWithoutAdInput } from '../../ad-house/inputs/ad-house-unchecked-create-nested-one-without-ad.input';
...
@InputType()
export class AdUncheckedCreateWithoutAd_categoriesInput {
    ...
    @Field(() => AdHouseUncheckedCreateNestedOneWithoutAdInput, {nullable:true})
    ad_house?: AdHouseUncheckedCreateNestedOneWithoutAdInput;
