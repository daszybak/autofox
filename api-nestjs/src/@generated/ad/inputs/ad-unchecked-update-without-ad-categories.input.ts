...
import { FileUncheckedUpdateManyWithoutAdNestedInput } from '../../file/inputs/file-unchecked-update-many-without-ad-nested.input';
...
@InputType()
export class AdUncheckedUpdateWithoutAd_categoriesInput {
    ...
    @Field(() => FileUncheckedUpdateManyWithoutAdNestedInput, {nullable:true})
    files?: FileUncheckedUpdateManyWithoutAdNestedInput;
