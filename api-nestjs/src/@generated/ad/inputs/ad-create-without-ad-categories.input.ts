...
import { AdPromotionCreateNestedManyWithoutAdInput } from '../../ad-promotion/inputs/ad-promotion-create-nested-many-without-ad.input';

@InputType()
export class AdCreateWithoutAd_categoriesInput {
    ...
    @Field(() => AdPromotionCreateNestedManyWithoutAdInput, {nullable:true})
    AdPromotion?: AdPromotionCreateNestedManyWithoutAdInput;
}
