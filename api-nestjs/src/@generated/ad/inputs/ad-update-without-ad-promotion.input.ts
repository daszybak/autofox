...
import { AdCategoryUpdateManyWithoutAdNestedInput } from '../../ad-category/inputs/ad-category-update-many-without-ad-nested.input';
...
@InputType()
export class AdUpdateWithoutAdPromotionInput {
    ...
    @Field(() => AdCategoryUpdateManyWithoutAdNestedInput, {nullable:true})
    ad_categories?: AdCategoryUpdateManyWithoutAdNestedInput;
